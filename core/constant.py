...
SHOP_BTN = {
    ...
    "tongchang": p(185, 69, img="img/shop/tongchang.bmp", at=(157, 56, 214, 82)),
    ...
    "xianding_locked": p(909, 68, img="img/shop/xianding_locked.bmp", at=(871, 49, 947, 87)),
    ...
    "dxc_btn": p(265, 67, img="img/shop/dxc_btn.bmp", at=(224, 56, 306, 78)),
    "jjc_btn": p(359, 68, img="img/shop/jjc_btn.bmp", at=(322, 57, 396, 80)),
    "pjjc_btn": p(456, 67, img="img/shop/pjjc_btn.bmp", at=(411, 55, 501, 80)),
    "clan_btn": p(544, 68, img="img/shop/clan_btn.bmp", at=(513, 57, 575, 80)),
    "nvshen_btn": p(826, 68, img="img/shop/nvshen_btn.bmp", at=(782, 56, 870, 81)),
...
JUESE_BTN = {
    ...
    "equip_selected": p(497, 74, img="img/juese/equip_selected.bmp", at=(470, 62, 524, 87)),
    "equip_unselected": p(499, 75, img="img/juese/equip_unselected.bmp", at=(470, 63, 528, 87)),
    ...
    "kaihua_unselected": p(738, 74, img="img/juese/kaihua_unselected.bmp", at=(703, 64, 774, 85)),
    "kaihua_selected": p(739, 74, img="img/juese/kaihua_selected.bmp", at=(703, 62, 775, 87)),
    ...
    "zhuanwu_selected": p(816, 74, img="img/juese/zhuanwu_selected.bmp", at=(780, 62, 853, 87)),
    "zhuanwu_unselected": p(818, 74, img="img/juese/zhuanwu_unselected.bmp", at=(782, 62, 854, 87)),
    ...
    "rank_on": p(245, 332, img="img/juese/rank_on.bmp", at=(209, 337, 283, 355)),
...
NORMAL_COORD = {
    ...
    65: {
        "right": {
            14: p(562, 262, name="65-10"),
            13: p(429, 286, name="65-S4"),
            12: p(340, 195, name="65-9"),
            11: p(285, 338, name="65-S3"),
            10: p(177, 311, name="65-8"),
            9: p(222, 177, name="65-7"),
            8: p(90, 226, name="65-6"),
        },
        "left": {
    ...
    66: {
        "right": {
            15: p(349, 183, name="66-10"),
            14: p(249, 189, name="66-S5"),
            13: p(134, 197, name="66-9"),
            12: p(235, 319, name="66-S4"),
            11: p(121, 324, name="66-8"),
        },
        "left": {
            10: p(692, 276, name="66-S3"),
            9: p(599, 222, name="66-7"),
            8: p(607, 380, name="66-6"),
            7: p(506, 328, name="66-5"),
            6: p(496, 171, name="66-S2"),
            5: p(380, 191, name="66-4"),
            4: p(289, 299, name="66-S1"),
            3: p(196, 406, name="66-3"),
