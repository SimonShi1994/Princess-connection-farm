...
wework_agid = GC.add_str('log', 'wework_agid')
...
force_primary_equals_secondary_use = GC.add_str('pcrfarm_setting', 'force_primary_equals_secondary_use', "本地4")
ocr_mode_main = GC.add_str('pcrfarm_setting', 'ocr_mode_main', "本地4")
