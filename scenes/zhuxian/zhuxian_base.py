import time
from typing import TYPE_CHECKING,AnyStr,Callable,Optional,Union

from core.constant import MAIN_BTN, JUESE_BTN, DXC_ELEMENT, MAOXIAN_BTN, FIGHT_BTN, ZHUXIAN_ID
from core.cv import UIMatcher
from core.pcr_checker import Checker, RetryNow, retry_run
...
class ZhuXianBase(SevenBTNMixin):
    ...
    def click_xy_and_open_fightinfo(self,x,y):
        pass
