...
class XianDingShangDian(ShopBase):
    ...
    def buy_all(self):
        self.click(388, 148, post_delay=0.1)
        self.clear_initFC()
        self.click(558, 149, post_delay=0.1)
        self.click(729, 149, post_delay=0.1)
        self.click(900, 148, post_delay=0.1)
        self._a.d.drag(613, 392, 613, 140, duration=0.1)
        self.click(388, 176, post_delay=0.1)
        self.click(559, 175, post_delay=0.1)
        self.click(729, 177, post_delay=0.1)
        self.click(899, 176, post_delay=0.1)
        # 点击购买
        self.click(794, 438)
        # 购买确认
