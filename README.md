...
7. **本项目下guild_40to1.py为新版40对1（还未测试）**

   未测试，慎用
   
   请在脚本内输入大号账号密码，公会1、2的会长的账号密码，公会1，2的名称，小号执行的日常任务
   
   在40to1_resource内，account_guild1,account_guild2中输入公会1，2的小号账号，第三个参数是任务，默认是“40to1_daily_task”，这里可修改为自己的任务（如果是批量任务请修改上面guild_40to1中的日常任务）
