...
1. **本项目下zhanghao.txt为待刷账号与密码**;
   ...
   下面为实例，标注图号后缀的将进行刷图和一些可支持的任务，不标注图号的不刷图，同时不进行捐赠
   
   可手动取消注释使得不刷装备的号去刷1-1经验，和进行其他DIY
   
   ```
   zhanghao1    mima1   h01n12tsk
   ...
   n07:刷主线7图; n08:刷主线8图; n10::刷主线10图; n11:刷主线11图; n12:刷主线12图
   
   tsk:探索开,适合给已经打过探索的账号扫荡
   
   后面跟的数字请根据刷图中心支持的数字填写,最高支持9位,可扩至12位.
...
- [ ] 更换jpg图片为bmp
- [ ] 优化代码，提高运行速度，降低出错率
- [ ] 整理代码，统一变量和函数snake_case命名，统一命名方式
- [ ] 24H挂机定时执行任务
